		...
		<tfoot>
			<tr>
				...
				<td colspan="6" class="t_r">
					...
					<a class="btn_gray btn_small mr_10" href="<?php echo IUrl::creatUrl("".$callback."");?>">继续购物</a>
					<?php if($this->goodsList){?>
					<a class="btn_brown btn_big mr_20" href="javascript:check_finish();">去结算</a>
					<?php }?>
				</td>
			</tr>
		</tfoot>
			...
			<ul id="scrollpic" class="prolist">
				...
				<li>
					<a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>">
						<img width="98px" height="106px" src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/98/h/106");?>" alt="<?php echo isset($item['name'])?$item['name']:"";?>" title="<?php echo isset($item['name'])?$item['name']:"";?>" onerror='this.src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/front/nopic_435_435.gif";?>"'>
					</a>
					...
					<label ><input type="submit" class='btn_gray btn_small' onclick="window.location.href='<?php echo IUrl::creatUrl("/simple/joinCart/link/cart/type/goods/goods_id/".$item['id']."");?>';" value="加入购物车"></label>
				</li>
				<?php }?>
			</ul>
		</div>

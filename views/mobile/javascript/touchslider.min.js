	/*//获取浏览器页面可见高度和宽度
        ...
        var _LoadingHtml = '<div id="loadingDiv" style="position:absolute;left:0;width:100%;height:' + _PageHeight + 'px;top:0;background:#f3f8ff;opacity:1;filter:alpha(opacity=100);z-index:999;"><div style="position: absolute; cursor1: wait; left: ' + _LoadingLeft + 'px; top:' + _LoadingTop + 'px;background: #fff url(/Content/loading.gif) no-repeat scroll 5px 10px; color: #696969; font-family:\'Microsoft YaHei\';"></div></div>';

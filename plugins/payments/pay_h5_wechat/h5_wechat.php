 ...
 * @brief 微信二维码插件类
 */
class h5_wechat extends paymentPlugin
{
    //支付插件名称
    public $name = '移动微信支付';
    ...
    { 
       ...
       // $editAddress = $tools->GetEditAddressParameters();
        ...
        {
            return(array('jsApiParameters' => $jsApiParameters,'order_id' => $payment['M_OrderNO'], 'product_id' => $temp,'pay_total' => $payment['M_Amount']*100,));
        }
    }

...
// 		}
    ...
    {
        $url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx245f90eb0759be3a&redirect_uri=".urlencode('http://www.yqtvt.com/test/simple/wecheatshoplogin')."&response_type=code&scope=snsapi_base&state=1#wechat_redirect";
        echo "<script language='javascript' type='text/javascript'>";

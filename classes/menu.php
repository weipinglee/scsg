...
class Menu
{
	...
	private static $menu = array(
		...
		'会员'=>array(
			...
			'平台信息处理' => array(
				'/comment/suggestion_list_plat'  => '建议管理',
				'/comment/refer_list_plat'		=> '咨询管理',
				'/comment/discussion_list_plat'	=> '讨论管理',
				'/comment/comment_list_plat'		=> '评价管理',
				'/message/notify_list_plat'      => '到货通知',
			),
			'商户信息处理' => array(
				'/comment/suggestion_list_client'  => '建议管理',
				'/comment/refer_list_client'		=> '咨询管理',
				'/comment/discussion_list_client'	=> '讨论管理',
				'/comment/comment_list_client'		=> '评价管理',
				'/message/notify_list_client'      => '到货通知',
			),
		),
	   ...
	   '订单'=>array(
        	'订单管理'=>array(
                ...
                '/order/order_list_client' => '商户订单',
                '/order/order_edit' => '添加订单',
                 '/preorder/preorder_list' => '预售订单',
        	),
        	'平台单据管理'=>array(
             	'/order/order_collection_list_plat'  => '收款单',
        	...
        	'商户单据管理'=>array(
             	'/order/order_collection_list_client'  => '收款单',
             	'/order/order_refundment_list_client'  => '退货单',
             	'/order/order_refundment_chg_list_client'=>'换货单',
        		'/order/order_delivery_list_client'    => '发货单',
        		'/order/refundment_list_client'        => '退货申请',
        		'/order/refundment_chg_list_client'    => '换货申请',
        		'/order/fapiao_list_client'            => '已开发票',
        		'/order/fapiao_client'                 => '发票申请'
        	),
        	'发货地址'=>array(
	...
	private static $menu_non_display = array(
		...
		'/order/collection_show_plat' => '/order/order_collection_list_plat',
		'/order/collection_show_client' => '/order/order_collection_list_client',
		'/order/refundment_show_plat' => '/order/order_refundment_list_plat',
		'/order/refundment_show_client' => '/order/order_refundment_list_client',
		'/order/delivery_show_plat' => '/order/order_delivery_list_plat',
		'/order/delivery_show_client' => '/order/order_delivery_list_client',
		'/order/refundment_doc_show' => '/order/order_refundment_list',
		'/order/refundment_chg_show_plat' => '/order/refundment_chg_list_plat',
		'/order/refundment_chg_show_client' => '/order/refundment_chg_list_client',
			'/order/refundment_chged_show' => '/order/order_refundment_chg_list',
			'/order/refundment_apply_show_plat' => '/order/refundment_list_plat',
			'/order/refundment_apply_show_client' => '/order/refundment_list_client',
